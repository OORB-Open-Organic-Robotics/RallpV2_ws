...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name), glob(os.path.join('', 'app.js'))),
        (os.path.join('share', package_name), glob(os.path.join('', 'index.html'))),
        (os.path.join('share', package_name), glob(os.path.join('', 'styles.css'))),
        (os.path.join('share', package_name), glob(os.path.join('', 'oorb_logo.png'))),
    ],
